...
<div class="btn-toolbar">
    ...
    <?php if (!Application::isReadonly()) { ?>
        ...
        <?php } ?>
    <?php } ?>
    <a class="btn btn-default <?php echo $this->application->view === 'export' ? 'active' : ''; ?>" onclick="callAjax('<?php echo Theme::URL('Collection/Export', array('db' => $this->db, 'collection' => $this->collection)); ?>');" href="javascript:void(0)"><?php I18n::p('EXPORT'); ?></a>
    <?php if (!Application::isReadonly()) { ?>
    ...
    <?php } ?>
    <a class="btn btn-default <?php echo $this->application->view === 'indexes' ? 'active' : ''; ?>" onclick="callAjax('<?php echo Theme::URL('Collection/Indexes', array('db' => $this->db, 'collection' => $this->collection)); ?>')" href="javascript:void(0)"><?php I18n::p('INDEXES'); ?></a>
