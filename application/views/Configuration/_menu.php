<div class="header">
    <h3 class="page-title"><i class="icon-database"></i><a href="<?php echo Theme::URL('Configuration/Index', array('path' => $this->path)); ?>" title="<?php echo $this->path;?>"><?php echo basename($this->path); ?></a> (<i class="icon-collection"></i><?php echo $this->file; ?>) </h3>
</div>
